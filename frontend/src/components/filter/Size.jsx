          ...
          <div className="row g-0">
            <div className="form-check col">
              ...
              <label className="form-check-label" htmlFor="flexCheckSize1">
                Nhà xuất bản kim đồng <span className="text-muted">(8)</span>
              </label>
            </div>
            ...
            <div className="form-check col">
              ...
              <label className="form-check-label" htmlFor="flexCheckSize4">
                Nhà xuất bản kim đồng <span className="text-muted">(9)</span>
              </label>
            </div>
          </div>
        </li>
          ...
          <div className="row g-0">
            <div className="form-check col">
              ...
              <label className="form-check-label" htmlFor="flexCheckSize2">
                Nhà xuất bản kim đồng <span className="text-muted">(10)</span>
              </label>
            </div>
            ...
            <div className="form-check col">
              ...
              <label className="form-check-label" htmlFor="flexCheckSize5">
                Nhà xuất bản kim đồng <span className="text-muted">(5)</span>
              </label>
            </div>
          </div>
        </li>
